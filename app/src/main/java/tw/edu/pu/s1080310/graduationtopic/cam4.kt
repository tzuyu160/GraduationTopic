...
import kotlinx.android.synthetic.main.activity_cam3.txv
...
class cam4 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cam4)
        getSupportActionBar()?.hide();


        lateinit var txv: TextView
        lateinit var viewFinder3: PreviewView



        txv = findViewById(R.id.txv)
        txv.text = "您尚未允許拍照權限"
        viewFinder3 = findViewById(R.id.viewFinder3)
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener(Runnable {
            ...
            val preview = Preview.Builder()
                .build()
                .also {
                    it.setSurfaceProvider(viewFinder3.surfaceProvider)
                }
