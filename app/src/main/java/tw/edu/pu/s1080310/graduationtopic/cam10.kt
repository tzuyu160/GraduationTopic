...
import kotlinx.android.synthetic.main.activity_cam10.*
import kotlinx.android.synthetic.main.activity_cam8.*
import kotlinx.android.synthetic.main.activity_cam9.*
import kotlinx.android.synthetic.main.activity_cam9.txv
import kotlinx.android.synthetic.main.activity_cam9.viewFinder8
...
class cam10 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cam10)
        getSupportActionBar()?.hide();


        lateinit var txv: TextView
        lateinit var viewFinder9: PreviewView

        txv = findViewById(R.id.txv)
        txv.text = "您尚未允許拍照權限"
        viewFinder9 = findViewById(R.id.viewFinder9)
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener(Runnable {
            ...
            val preview = Preview.Builder()
                .build()
                .also {
                    it.setSurfaceProvider(viewFinder9.surfaceProvider)
                }
