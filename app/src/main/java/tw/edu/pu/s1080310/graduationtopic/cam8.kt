...
import kotlinx.android.synthetic.main.activity_cam7.txv
import kotlinx.android.synthetic.main.activity_cam7.viewFinder6
...
class cam8 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cam8)
        getSupportActionBar()?.hide();


        lateinit var txv: TextView
        lateinit var viewFinder7: PreviewView

        txv = findViewById(R.id.txv)
        txv.text = "您尚未允許拍照權限"
        viewFinder7 = findViewById(R.id.viewFinder7)
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener(Runnable {
            ...
            val preview = Preview.Builder()
                .build()
                .also {
                    it.setSurfaceProvider(viewFinder7.surfaceProvider)
                }
