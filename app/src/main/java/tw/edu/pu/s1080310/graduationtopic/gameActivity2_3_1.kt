...
import kotlinx.android.synthetic.main.activity_game2_2_1.eraser3
import kotlinx.android.synthetic.main.activity_game2_3_1.*
import org.tensorflow.lite.support.image.TensorImage
import tw.edu.pu.s1080310.graduationtopic.ml.Shapemodel1

class gameActivity2_3_1 : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_game2_3_1)
        ...
        eraser4.setOnClickListener(this)
        draw_view5.setOnTouchListener(this)

        draw_view5.setStrokeWidth(50.0f) //畫筆粗細
        draw_view5.setColor(Color.argb(0xff,205,155,155)) //畫筆顏色
        draw_view5.setBackgroundColor(Color.argb(0xff,209,238,238)) //背景顏色
    ...
    override fun onClick(p0: View?) {
        draw_view5.clearCanvas()
    }

    override fun onTouch(p0: View?, event: MotionEvent): Boolean {
        draw_view5.onTouchEvent(event)
        if (event.action == MotionEvent.ACTION_UP){
            //Toast.makeText(this, "手指彈起",Toast.LENGTH_SHORT).show()
            classifyDrawing(draw_view5.getBitmap())
        }
        return true
    }
