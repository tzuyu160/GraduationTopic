...
import kotlinx.android.synthetic.main.activity_cam10.txv
import kotlinx.android.synthetic.main.activity_cam11.*
...
class cam11 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cam11)
        getSupportActionBar()?.hide();


        lateinit var txv: TextView
        lateinit var viewFinder10: PreviewView

        txv = findViewById(R.id.txv)
        txv.text = "您尚未允許拍照權限"
        viewFinder10 = findViewById(R.id.viewFinder10)
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener(Runnable {
            ...
            val preview = Preview.Builder()
                .build()
                .also {
                    it.setSurfaceProvider(viewFinder10.surfaceProvider)
                }
