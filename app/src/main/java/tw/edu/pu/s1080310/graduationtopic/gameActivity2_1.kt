...
class gameActivity2_1 : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        eraser1.setOnClickListener(this)
        draw_view3.setOnTouchListener(this)

        draw_view3.setStrokeWidth(50.0f) //畫筆粗細
        draw_view3.setColor(Color.argb(0xff,205,155,155)) //畫筆顏色
        draw_view3.setBackgroundColor(Color.argb(0xff,209,238,238)) //背景顏色


    }

    override fun onClick(p0: View?) {
        draw_view3.clearCanvas()
    }

    override fun onTouch(p0: View?, event: MotionEvent): Boolean {
        draw_view3.onTouchEvent(event)
        if (event.action == MotionEvent.ACTION_UP){
            //Toast.makeText(this, "手指彈起",Toast.LENGTH_SHORT).show()
            classifyDrawing(draw_view3.getBitmap())
        }
        return true
    }
    ...
    fun classifyDrawing(bitmap: Bitmap) {
        ...
        if(Result=="圓形"&&outputs[0].score * 100.0f>30) {
            ...
            intent = Intent(this@gameActivity2_1, gameActivity2_2::class.java)
