...
import kotlinx.android.synthetic.main.activity_cam6.txv
...
class cam7 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cam7)
        getSupportActionBar()?.hide();


        lateinit var txv: TextView
        lateinit var viewFinder6: PreviewView

        txv = findViewById(R.id.txv)
        txv.text = "您尚未允許拍照權限"
        viewFinder6 = findViewById(R.id.viewFinder6)
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener(Runnable {
            ...
            val preview = Preview.Builder()
                .build()
                .also {
                    it.setSurfaceProvider(viewFinder6.surfaceProvider)
                }
