...
import kotlinx.android.synthetic.main.activity_cam4.*
import kotlinx.android.synthetic.main.activity_cam5.*
import kotlinx.android.synthetic.main.activity_cam5.txv
import kotlinx.android.synthetic.main.activity_cam5.viewFinder4
import kotlinx.android.synthetic.main.activity_cam6.*
...
class cam6 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lateinit var viewFinder5: PreviewView

        txv = findViewById(R.id.txv)
        txv.text = "您尚未允許拍照權限"
        viewFinder5 = findViewById(R.id.viewFinder5)
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener(Runnable {
            ...
            val preview = Preview.Builder()
                .build()
                .also {
                    it.setSurfaceProvider(viewFinder5.surfaceProvider)
                }
    ...
    fun classifyDrawing(bitmap : Bitmap) {
        ...
        if(Result=="貨車"&&outputs[0].score * 100.0f>30) {
            txv.text="答對"
            intent = Intent(this@cam6, life2_6::class.java)
