...
import kotlinx.android.synthetic.main.activity_cam3.*
import kotlinx.android.synthetic.main.activity_cam4.*
import kotlinx.android.synthetic.main.activity_cam4.txv
...
class cam5 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lateinit var viewFinder4: PreviewView

        txv = findViewById(R.id.txv)
        txv.text = "您尚未允許拍照權限"
        viewFinder4 = findViewById(R.id.viewFinder4)
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener(Runnable {
            ...
            val preview = Preview.Builder()
                .build()
                .also {
                    it.setSurfaceProvider(viewFinder4.surfaceProvider)
                }
    ...
    fun classifyDrawing(bitmap : Bitmap) {
        ...
        if(Result=="貨車"&&outputs[0].score * 100.0f>10) {
            txv.text="答對"
            intent = Intent(this@cam5, life2_5::class.java)
